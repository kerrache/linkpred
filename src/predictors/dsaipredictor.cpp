...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> void DSAIPredictor<
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> double DSAIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
	...
	return nbcn / (std::sqrt((double) net->getOutDeg(i) * net->getInDeg(j))
						+ std::numeric_limits<double>::epsilon());
}

template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> std::size_t DSAIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
...
#define DSAIPREDICTOR_CPP
#include "linkpred/instantiations.hpp"
#undef DSAIPREDICTOR_CPP
