...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> void DJIDPredictor<
...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> double DJIDPredictor<
		Network, EdgeRndIt, ScoreRndIt,
	...
	return nbcn
			/ ((double) (degI + degJ - nbcn)
					+ std::numeric_limits<double>::epsilon());
}

template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> std::size_t DJIDPredictor<
		Network, EdgeRndIt, ScoreRndIt,
