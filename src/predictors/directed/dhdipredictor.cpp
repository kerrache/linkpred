...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> void DHDIPredictor<
...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> double DHDIPredictor<
		Network, EdgeRndIt, ScoreRndIt,
	...
	return nbcn
			/ ((double) std::max(net->getOutDeg(i), net->getInDeg(j))
					+ std::numeric_limits<double>::epsilon());
}

template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> std::size_t DHDIPredictor<
		Network, EdgeRndIt, ScoreRndIt,
