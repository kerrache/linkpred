...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> void DSAIPredictor<
...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> double DSAIPredictor<
		Network, EdgeRndIt, ScoreRndIt,
	...
	return nbcn
			/ (std::sqrt((double) net->getOutDeg(i) * net->getInDeg(j))
					+ std::numeric_limits<double>::epsilon());
}

template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> std::size_t DSAIPredictor<
		Network, EdgeRndIt, ScoreRndIt,
