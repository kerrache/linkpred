...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> void DSOIPredictor<
...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> double DSOIPredictor<
		Network, EdgeRndIt, ScoreRndIt,
	...
	return 2.0 * nbcn
			/ (net->getOutDeg(i) + net->getInDeg(j)
					+ std::numeric_limits<double>::epsilon());
}

template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> std::size_t DSOIPredictor<
		Network, EdgeRndIt, ScoreRndIt,
