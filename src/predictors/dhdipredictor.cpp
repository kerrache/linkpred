 ...
 * Copyright (C) 2017  by HDId Kerrache.
 *
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> void DHDIPredictor<
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> double DHDIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
	...
	return nbcn / ((double)std::max(net->getOutDeg(i), net->getInDeg(j)) + std::numeric_limits<double>::epsilon());
}

template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> std::size_t DHDIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
...
#define DHDIPREDICTOR_CPP
#include "linkpred/instantiations.hpp"
#undef DHDIPREDICTOR_CPP
