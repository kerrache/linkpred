...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> void DHPIPredictor<
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> double DHPIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
	...
	return nbcn / ((double)std::min(net->getOutDeg(i), net->getInDeg(j)) + std::numeric_limits<double>::epsilon());
}

template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> std::size_t DHPIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
