...
#include "linkpred/predictors/usbmpredictor/models.h"
#include "linkpred/predictors/usbmpredictor/missing.h"
#include "linkpred/predictors/usbmpredictor/recommend.h"
#include "linkpred/predictors/usbmpredictor/conflict.h"
 ...
 */
struct query **
AllLinkScore2State(struct binet *ratings, int nIter, gsl_rng *gen,
		char verbose_sw, int decorStep) {
