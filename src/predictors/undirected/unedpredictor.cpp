...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> void UNEDPredictor<
...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> double UNEDPredictor<
		Network, EdgeRndIt, ScoreRndIt,
...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> std::size_t UNEDPredictor<
		Network, EdgeRndIt, ScoreRndIt,
