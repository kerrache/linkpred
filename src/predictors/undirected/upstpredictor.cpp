...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> void UPSTPredictor<
...
template<typename Network, typename EdgeRndIt,
		typename ScoreRndIt, typename EdgeRndOutIt> double UPSTPredictor<
		Network, EdgeRndIt, ScoreRndIt,
		EdgeRndOutIt>::score(Edge const & e) {
	return edgeScores->at(e);
}

#define UPSTPREDICTOR_CPP
#include "linkpred/instantiations.hpp"
#undef UPSTPREDICTOR_CPP
