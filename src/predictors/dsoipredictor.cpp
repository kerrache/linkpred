...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> void DSOIPredictor<
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> double DSOIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
	...
	return 2.0 * nbcn / (net->getOutDeg(i) + net->getInDeg(j)
						+ std::numeric_limits<double>::epsilon());
}

template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> std::size_t DSOIPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
...
#define DSOIPREDICTOR_CPP
#include "linkpred/instantiations.hpp"
#undef DSOIPREDICTOR_CPP
