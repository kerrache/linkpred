 ...
 * Copyright (C) 2017  by LHNd Kerrache.
 *
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> void DLHNPredictor<
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> double DLHNPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
	...
	return nbcn / ((double)(net->getOutDeg(i) * net->getInDeg(j)) + std::numeric_limits<double>::epsilon());
}

template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> std::size_t DLHNPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
...
#define DLHNPREDICTOR_CPP
#include "linkpred/instantiations.hpp"
#undef DLHNPREDICTOR_CPP
