...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> void UNEDPredictor<
...
template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> double UNEDPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
	...
	double ki = net->getDeg(srcNode);
	double kj = net->getDeg(endNode);
	return nsc(srcNode, endNode, ki, kj);
}

template<typename NetworkT, typename EdgesRandomIteratorT,
		typename ScoresRandomIteratorT, typename EdgesRandomOutputIteratorT> std::size_t UNEDPredictor<
		NetworkT, EdgesRandomIteratorT, ScoresRandomIteratorT,
...
#define UNEDPREDICTOR_CPP
#include "linkpred/instantiations.hpp"
#undef UNEDPREDICTOR_CPP
