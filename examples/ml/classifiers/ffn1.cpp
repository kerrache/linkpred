...
int main(int argc, char *argv[]) {
	...
	classifier->Add<mlpack::ann::Linear<> >(3, 5);
	classifier->Add<mlpack::ann::SigmoidLayer<> >();
	classifier->Add<mlpack::ann::Linear<> >(5, 2);
	classifier->Add<mlpack::ann::LogSoftMax<> >();

	classifier->learn(trInput.begin(), trInput.end(), trOutput.begin(), trOutput.end());
