...
class EdgeScoreByID(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    i = property(_LinkPredPython.EdgeScoreByID_i_get, _LinkPredPython.EdgeScoreByID_i_set)
    j = property(_LinkPredPython.EdgeScoreByID_j_get, _LinkPredPython.EdgeScoreByID_j_set)
    score = property(_LinkPredPython.EdgeScoreByID_score_get, _LinkPredPython.EdgeScoreByID_score_set)

    def __init__(self):
        _LinkPredPython.EdgeScoreByID_swiginit(self, _LinkPredPython.new_EdgeScoreByID())
    __swig_destroy__ = _LinkPredPython.delete_EdgeScoreByID

# Register EdgeScoreByID in _LinkPredPython:
_LinkPredPython.EdgeScoreByID_swigregister(EdgeScoreByID)
...
class EdgeScoreByIDVec(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _LinkPredPython.EdgeScoreByIDVec_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _LinkPredPython.EdgeScoreByIDVec___nonzero__(self)

    def __bool__(self):
        return _LinkPredPython.EdgeScoreByIDVec___bool__(self)

    def __len__(self):
        return _LinkPredPython.EdgeScoreByIDVec___len__(self)

    def __getslice__(self, i, j):
        return _LinkPredPython.EdgeScoreByIDVec___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _LinkPredPython.EdgeScoreByIDVec___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _LinkPredPython.EdgeScoreByIDVec___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _LinkPredPython.EdgeScoreByIDVec___delitem__(self, *args)

    def __getitem__(self, *args):
        return _LinkPredPython.EdgeScoreByIDVec___getitem__(self, *args)

    def __setitem__(self, *args):
        return _LinkPredPython.EdgeScoreByIDVec___setitem__(self, *args)

    def pop(self):
        return _LinkPredPython.EdgeScoreByIDVec_pop(self)

    def append(self, x):
        return _LinkPredPython.EdgeScoreByIDVec_append(self, x)

    def empty(self):
        return _LinkPredPython.EdgeScoreByIDVec_empty(self)

    def size(self):
        return _LinkPredPython.EdgeScoreByIDVec_size(self)

    def swap(self, v):
        return _LinkPredPython.EdgeScoreByIDVec_swap(self, v)

    def begin(self):
        return _LinkPredPython.EdgeScoreByIDVec_begin(self)

    def end(self):
        return _LinkPredPython.EdgeScoreByIDVec_end(self)

    def rbegin(self):
        return _LinkPredPython.EdgeScoreByIDVec_rbegin(self)

    def rend(self):
        return _LinkPredPython.EdgeScoreByIDVec_rend(self)

    def clear(self):
        return _LinkPredPython.EdgeScoreByIDVec_clear(self)

    def get_allocator(self):
        return _LinkPredPython.EdgeScoreByIDVec_get_allocator(self)

    def pop_back(self):
        return _LinkPredPython.EdgeScoreByIDVec_pop_back(self)

    def erase(self, *args):
        return _LinkPredPython.EdgeScoreByIDVec_erase(self, *args)

    def __init__(self, *args):
        _LinkPredPython.EdgeScoreByIDVec_swiginit(self, _LinkPredPython.new_EdgeScoreByIDVec(*args))

    def push_back(self, x):
        return _LinkPredPython.EdgeScoreByIDVec_push_back(self, x)

    def front(self):
        return _LinkPredPython.EdgeScoreByIDVec_front(self)

    def back(self):
        return _LinkPredPython.EdgeScoreByIDVec_back(self)

    def assign(self, n, x):
        return _LinkPredPython.EdgeScoreByIDVec_assign(self, n, x)

    def resize(self, *args):
        return _LinkPredPython.EdgeScoreByIDVec_resize(self, *args)

    def insert(self, *args):
        return _LinkPredPython.EdgeScoreByIDVec_insert(self, *args)

    def reserve(self, n):
        return _LinkPredPython.EdgeScoreByIDVec_reserve(self, n)

    def capacity(self):
        return _LinkPredPython.EdgeScoreByIDVec_capacity(self)
    __swig_destroy__ = _LinkPredPython.delete_EdgeScoreByIDVec

# Register EdgeScoreByIDVec in _LinkPredPython:
_LinkPredPython.EdgeScoreByIDVec_swigregister(EdgeScoreByIDVec)
...
class Predictor(object):
    ...
    def getNbNodes(self):
        return _LinkPredPython.Predictor_getNbNodes(self)

    def getLabel(self, i):
        return _LinkPredPython.Predictor_getLabel(self, i)

    def getID(self, i):
        return _LinkPredPython.Predictor_getID(self, i)

    def isEdgeByID(self, i, j):
        return _LinkPredPython.Predictor_isEdgeByID(self, i, j)

    def isEdgeByLabel(self, i, j):
        return _LinkPredPython.Predictor_isEdgeByLabel(self, i, j)
    ...
    def predAllECL(self, *args):
        return _LinkPredPython.Predictor_predAllECL(self, *args)

    def predECL(self, *args):
        return _LinkPredPython.Predictor_predECL(self, *args)

    def predTopECL(self, *args):
        return _LinkPredPython.Predictor_predTopECL(self, *args)

    def predAllESM(self, *args):
        return _LinkPredPython.Predictor_predAllESM(self, *args)

    def predESM(self, *args):
        return _LinkPredPython.Predictor_predESM(self, *args)

    def predTopESM(self, *args):
        return _LinkPredPython.Predictor_predTopESM(self, *args)
    ...
    def predAllADAByID(self):
        return _LinkPredPython.Predictor_predAllADAByID(self)

    def predAllCNEByID(self):
        return _LinkPredPython.Predictor_predAllCNEByID(self)

    def predAllCRAByID(self):
        return _LinkPredPython.Predictor_predAllCRAByID(self)

    def predAllECLByID(self, *args):
        return _LinkPredPython.Predictor_predAllECLByID(self, *args)

    def predAllESMByID(self, *args):
        return _LinkPredPython.Predictor_predAllESMByID(self, *args)

    def predAllFBMByID(self, maxIter=50, seed=0):
        return _LinkPredPython.Predictor_predAllFBMByID(self, maxIter, seed)

    def predAllHDIByID(self):
        return _LinkPredPython.Predictor_predAllHDIByID(self)

    def predAllHPIByID(self):
        return _LinkPredPython.Predictor_predAllHPIByID(self)

    def predAllHRGByID(self, nbBeans=25, nbSamples=10000, seed=0):
        return _LinkPredPython.Predictor_predAllHRGByID(self, nbBeans, nbSamples, seed)

    def predAllHYPByID(self, m=1.5, L=1, gamma=2.1, zeta=1, T=0.8, seed=0):
        return _LinkPredPython.Predictor_predAllHYPByID(self, m, L, gamma, zeta, T, seed)

    def predAllJIDByID(self):
        return _LinkPredPython.Predictor_predAllJIDByID(self)

    def predAllKABByID(self, horizLim=2):
        return _LinkPredPython.Predictor_predAllKABByID(self, horizLim)

    def predAllLCPByID(self, epsilon=0.001):
        return _LinkPredPython.Predictor_predAllLCPByID(self, epsilon)

    def predAllLHNByID(self):
        return _LinkPredPython.Predictor_predAllLHNByID(self)

    def predAllPATByID(self):
        return _LinkPredPython.Predictor_predAllPATByID(self)

    def predAllRALByID(self):
        return _LinkPredPython.Predictor_predAllRALByID(self)

    def predAllRNDByID(self, seed=0):
        return _LinkPredPython.Predictor_predAllRNDByID(self, seed)

    def predAllSAIByID(self):
        return _LinkPredPython.Predictor_predAllSAIByID(self)

    def predAllSBMByID(self, maxIter=1000, seed=0):
        return _LinkPredPython.Predictor_predAllSBMByID(self, maxIter, seed)

    def predAllSHPByID(self, seed=0):
        return _LinkPredPython.Predictor_predAllSHPByID(self, seed)

    def predAllSOIByID(self):
        return _LinkPredPython.Predictor_predAllSOIByID(self)
...
class Evaluator(object):
    ...
    def addECL(self, *args):
        return _LinkPredPython.Evaluator_addECL(self, *args)

    def addESM(self, *args):
        return _LinkPredPython.Evaluator_addESM(self, *args)
    ...
    def addPST(self, *args):
        return _LinkPredPython.Evaluator_addPST(self, *args)
    ...
    def genTestData(self, fullNetFileName, obsEdgesFileName, remEdgesFileName, remRatio=0.1, keepConnected=False, seed=0):
        return _LinkPredPython.Evaluator_genTestData(self, fullNetFileName, obsEdgesFileName, remEdgesFileName, remRatio, keepConnected, seed)
