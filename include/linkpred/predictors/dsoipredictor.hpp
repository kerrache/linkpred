...
#ifndef DSOIPREDICTOR_HPP_
#define DSOIPREDICTOR_HPP_
...
template<typename NetworkT = DNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class DSOIPredictor: public DLPredictor<
...
public:
	 ...
	 */
	DSOIPredictor(std::shared_ptr<NetworkT const> net) :
