...
#ifndef DHPIPREDICTOR_HPP_
#define DHPIPREDICTOR_HPP_
...
template<typename NetworkT = DNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class DHPIPredictor: public DLPredictor<
...
public:
	 ...
	 */
	DHPIPredictor(std::shared_ptr<NetworkT const> net) :
