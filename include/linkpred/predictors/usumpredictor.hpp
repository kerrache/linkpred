...
/**
 * \file
 * @brief Contains the implementation of a sum-of-degrees link predictor.
 */

#ifndef USUMPREDICTOR_HPP_
#define USUMPREDICTOR_HPP_
...
template<typename NetworkT = UNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class USUMPredictor: public ULPredictor<
...
public:
	 ...
	 */
	USUMPredictor(std::shared_ptr<NetworkT const> net) :
