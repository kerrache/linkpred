...
#ifndef UPSTPREDICTOR_HPP_
#define UPSTPREDICTOR_HPP_
...
template<typename Network = UNetwork<>,
		...
		typename EdgeRndOutIt = typename std::vector<typename Network::Edge>::iterator> class UPSTPredictor: public ULPredictor<
