...
/**
 * \file
 * @brief Contains the implementation of a Salton index link predictor.
 */

#ifndef USAIPREDICTOR_HPP_
#define USAIPREDICTOR_HPP_
...
/**
 * @brief A Salton index link predictor.
...
template<typename NetworkT = UNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class USAIPredictor: public ULPredictor<
...
public:
	 ...
	 */
	USAIPredictor(std::shared_ptr<NetworkT const> net) :
