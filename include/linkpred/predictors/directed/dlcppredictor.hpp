 ...
 * \file
 * @ingroup Predictors
 * @brief Contains the implementation of a directed LCP link predictor.
 */

#ifndef DLCPPREDICTOR_HPP_
#define DLCPPREDICTOR_HPP_
...
template<typename Network = DNetwork<>,
		...
		typename EdgeRndOutIt = typename std::vector<typename Network::Edge>::iterator> class DLCPPredictor: public DLPredictor<
...
public:
	 ...
	 */
	//virtual std::size_t top(std::size_t k, EdgeRndOutIt eit,
	//		ScoreRndIt sit);
	/**
	 * Destructor.
	 */
