...
#ifndef DADAPREDICTOR_HPP_
#define DADAPREDICTOR_HPP_
...
template<typename Network = DNetwork<>,
		...
		typename EdgeRndOutIt = typename std::vector<typename Network::Edge>::iterator> class DADAPredictor: public DLPredictor<
