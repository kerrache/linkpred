...
#ifndef DPATPREDICTOR_HPP_
#define DPATPREDICTOR_HPP_
...
template<typename Network = DNetwork<>,
		...
		typename EdgeRndOutIt = typename std::vector<typename Network::Edge>::iterator> class DPATPredictor: public DLPredictor<
