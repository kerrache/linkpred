...
#ifndef DLHNPREDICTOR_HPP_
#define DLHNPREDICTOR_HPP_
...
template<typename NetworkT = DNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class DLHNPredictor: public DLPredictor<
...
public:
	 ...
	 */
	DLHNPredictor(std::shared_ptr<NetworkT const> net) :
