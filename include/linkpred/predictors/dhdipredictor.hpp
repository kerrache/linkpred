...
#ifndef DHDIPREDICTOR_HPP_
#define DHDIPREDICTOR_HPP_
...
template<typename NetworkT = DNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class DHDIPredictor: public DLPredictor<
...
public:
	 ...
	 */
	DHDIPredictor(std::shared_ptr<NetworkT const> net) :
