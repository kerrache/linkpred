...
/**
 * \file
 * @brief Contains the implementation of a hub promoted index link predictor.
 */

#ifndef UHPIPREDICTOR_HPP_
#define UHPIPREDICTOR_HPP_
...
/**
 * @brief Hub promoted index link predictor.
...
template<typename NetworkT = UNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class UHPIPredictor: public ULPredictor<
...
public:
	 ...
	 */
	UHPIPredictor(std::shared_ptr<NetworkT const> net) :
