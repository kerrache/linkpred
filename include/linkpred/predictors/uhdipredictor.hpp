...
/**
 * \file
 * @brief Contains the implementation of a hub depromoted index link predictor.
 */

#ifndef UHDIPREDICTOR_HPP_
#define UHDIPREDICTOR_HPP_
...
/**
 * @brief Hub depromoted index link predictor.
...
template<typename NetworkT = UNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class UHDIPredictor: public ULPredictor<
...
public:
	 ...
	 */
	UHDIPredictor(std::shared_ptr<NetworkT const> net) :
...
#endif /* INCLUDE_HDIPREDICTOR_HPP_ */
