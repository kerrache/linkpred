...
/**
 * \file
 * @brief Contains the implementation of a resource allocation link predictor.
 */

#ifndef URALPREDICTOR_HPP_
#define URALPREDICTOR_HPP_
...
/**
 * @brief A resource allocation link predictor.
...
template<typename NetworkT = UNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class URALPredictor: public ULPredictor<
...
public:
	 ...
	 */
	URALPredictor(std::shared_ptr<NetworkT const> net) :
