...
#ifndef DJIDPREDICTOR_HPP_
#define DJIDPREDICTOR_HPP_
...
template<typename NetworkT = DNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class DJIDPredictor: public DLPredictor<
...
public:
	 ...
	 */
	DJIDPredictor(std::shared_ptr<NetworkT const> net) :
