...
#ifndef UCNEPREDICTOR_HPP_
#define UCNEPREDICTOR_HPP_
...
/**
 * @brief Common neighbor link predictor.
...
template<typename NetworkT = UNetwork<>,
		...
		typename EdgesRandomOutputIteratorT = typename std::vector<
				typename NetworkT::EdgeType>::iterator> class UCNEPredictor: public ULPredictor<
...
public:
	 ...
	 */
	UCNEPredictor(std::shared_ptr<NetworkT const> net) :
